...
void Game_Colour::show_info_about_game() {
	if (variable_replaced_by_reference == false)
		std::cout << "Kolor przegral " << players_pointer[player_who_chose_colour]->get_name() << std:: endl;
	else std::cout << "Kolor wygral " << players_pointer[player_who_chose_colour]->get_name() << std::endl;
	system("pause");
}
